...
import type { State, AnonFeedPrivateState, Contract, Witnesses } from '../../contract/src/index';

export const AnonFeedPrivateStateKey = 'AnonFeedPrivateState';
export type PrivateStateId = typeof AnonFeedPrivateStateKey;
...
export type PrivateStates = {
  /**
   * Key used to provide the private state for {@link AnonFeedContract} deployments.
   */
  readonly AnonFeedPrivateState: AnonFeedPrivateState;
};
 ...
 * @public
 */
export type AnonFeedContract = Contract<AnonFeedPrivateState, Witnesses<AnonFeedPrivateState>>;

/**
 * The keys of the circuits exported from {@link AnonFeedContract}.
 *
 * @public
 */
export type AnonFeedCircuitKeys = Exclude<keyof AnonFeedContract['impureCircuits'], number | symbol>;

/**
 * The providers required by {@link AnonFeedContract}.
 *
 * @public
 */
export type AnonFeedProviders = MidnightProviders<AnonFeedCircuitKeys, PrivateStateId, AnonFeedPrivateState>;

/**
 * A {@link AnonFeedContract} that has been deployed to the network.
 *
 * @public
 */
export type DeployedAnonFeedContract = FoundContract<AnonFeedContract>;

/**
 * A type that represents the derived combination of public (or ledger), and private state.
 */
export type AnonFeedDerivedState = {
   ...
   * the `secretKey` property of {@link AnonFeedPrivateState} is the secret key of the current user. If
