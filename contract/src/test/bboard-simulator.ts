...
import {
  ...
  type Ledger,
  ledger,
} from "../managed/anon-feed/contract/index.js";
import { type AnonFeedPrivateState, witnesses } from "../witnesses.js";

/**
 * Serves as a testbed to exercise the contract in tests
 */
export class AnonFeedSimulator {
  readonly contract: Contract<AnonFeedPrivateState>;
  circuitContext: CircuitContext<AnonFeedPrivateState>;

  constructor(secretKey: Uint8Array) {
    this.contract = new Contract<AnonFeedPrivateState>(witnesses);
    const {
      currentPrivateState,
  ...
  public getPrivateState(): AnonFeedPrivateState {
