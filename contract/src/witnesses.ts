...
import { Ledger } from "./managed/anon-feed/contract/index.js";
...
export type AnonFeedPrivateState = {
  readonly secretKey: Uint8Array;
};

export const createAnonFeedPrivateState = (secretKey: Uint8Array) => ({
  secretKey,
});
 ...
 *  is the private state type, like AnonFeedPrivateState defined above.
 *
 ...
 * the declared return value.  In this case, that's a AnonFeedPrivateState
...
export const witnesses = {
  localSecretKey: ({
    privateState,
  }: WitnessContext<Ledger, AnonFeedPrivateState>): [
    AnonFeedPrivateState,
    Uint8Array,
