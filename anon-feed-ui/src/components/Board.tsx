      ...
      {boardDeployment$ && (
        <React.Fragment>
          ...
          >
            ...
            <Typography variant="caption" sx={{ color: '#00C9FF', fontWeight: 700, fontSize: '0.8rem' }}>
              Generating ZK proof…
            </Typography>
            <Typography
              variant="caption"
              sx={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.7rem', textAlign: 'center', px: 2 }}
            >
          ...
          >
            ...
            <Typography
              ...
              sx={{ color: '#ff6666', textAlign: 'center' }}
            >
              {errorMessage}
            </Typography>
          ...
          <CardHeader
            ...
            title={
              <Typography
                variant="caption"
                sx={{ color: 'rgba(255,255,255,0.5)', fontFamily: 'monospace', fontSize: '0.75rem' }}
              >
            ...
            subheader={
              boardState ? (
                <Typography
                  variant="caption"
                  sx={{ color: isOccupied ? '#92FE9D' : 'rgba(255,255,255,0.35)', fontSize: '0.7rem' }}
                >
          ...
          <CardActions sx={{ px: 2, pb: 1, gap: 1, flexDirection: 'column', alignItems: 'flex-start' }}>
            ...
            {boardState && (
              ...
              >
                ...
                <Typography
                  variant="caption"
                  sx={{ color: 'rgba(255,255,255,0.45)', fontSize: '0.68rem', lineHeight: 1.4 }}
                >
                  {isOccupied && isOwner
                  ...
                  >
                    <span>
                      ...
                      >
                        ...
                        <Typography variant="caption" sx={{ color: '#00C9FF', fontWeight: 600 }}>
                          Post
                        </Typography>
                      </IconButton>
                    </span>
                  ...
                  <Tooltip
                    title={
                      isVacant
                        ? 'Nothing to remove'
                        : !isOwner
                          ? 'Not your message — ZK proof required'
                          : 'Remove your message'
                    }
                  >
                    <span>
                      ...
                      >
                        ...
                        <Typography variant="caption" sx={{ color: '#ff6666', fontWeight: 600 }}>
                          Remove
                        </Typography>
                      </IconButton>
                    </span>
